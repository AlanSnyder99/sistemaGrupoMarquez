...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    <form class="form-inline" method="POST" action="<?php echo "../administrador/verServicioBuscado?idUsuario=".$idUsuario."" ?>">
...
<?php
  ...
  <li class='list-group-item'>idServicio: ".$servicios['idServicios']." <br> Nombre:  ".$servicios['nombre']."<br><a class='btn btn-info' role='button'  href='../administrador/verServicio?idUsuario=".$idUsuario."&servicioId=".$servicios['idServicios']." ' >Ver</a> </li
</ul>
<br>
