...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="well well-sm">
                <form class="form-horizontal" method="POST" action= "<?php echo "../administrador/grabarModificacionCliente?idUsuario=".$idUsuario."&cliente=".$data2['idClientes']."" ?>"  enctype="multipart/form-data">
  ...
  <br>
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input id="fname" name="nombreCliente" type="text" class="form-control" value="<?php echo $data2['nombreCompleto']; ?>">
                                 <input id="fname" name="nombreCliente2" type="hidden" class="form-control" value="<?php echo $data2['nombreCompleto']; ?>">
                            </div>
                        </div>
                        <br>
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input id="fname" name="dni" type="text"  class="form-control" value="<?php echo $data2['dni']; ?>">
                                <input id="fname" name="dni2" type="hidden" class="form-control" value="<?php echo $data2['dni']; ?>">
  ...
  <br>
                         <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input id="fname" name="producto" type="text"  class="form-control" value="<?php echo $data2['productoComprado']; ?>" >
                                <input id="fname" name="producto2" type="hidden" class="form-control" value="<?php echo $data2['productoComprado']; ?>">
 ...
 <br>
                       <div class="form-group">
                            ...
                            <div class="col-md-7">
                                ...
                                <option><?php echo $idTarjeta."-".$nombreTarjeta  ?></option>
                                <option></option>
...
<br>
                     <div class="row">
                            <div class="col-md-12 text-center">
                                <input class="btn btn-primary"  type="submit" name="submit" id="submit" value="Grabar">
                            </div>
                        </div>
